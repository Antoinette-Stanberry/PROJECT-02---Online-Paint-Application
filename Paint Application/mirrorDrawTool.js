/* NOTE
- this function is used as a mirror, as it splits the canvas in half
(vertically & horizontallly to user's discretion), and replicates the 
user's actions from one side to the other
*/
// -----------------------------------------------------------------------------------//
